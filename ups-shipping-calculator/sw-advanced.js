// Advanced Service Worker v4.0 - ups-shipping-calculator
...
const CACHE_PREFIX = 'zovo-upsshippingcalculator';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for ups-shipping-calculator');
...
console.log('[SW] Advanced service worker for ups-shipping-calculator loaded successfully');