// Advanced Service Worker v4.0 - td-exchange-rate-converter
...
const CACHE_PREFIX = 'zovo-tdexchangerateconverter';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for td-exchange-rate-converter');
...
console.log('[SW] Advanced service worker for td-exchange-rate-converter loaded successfully');