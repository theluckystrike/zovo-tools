// Advanced Service Worker v4.0 - whois-lookup
...
const CACHE_PREFIX = 'zovo-whoislookup';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for whois-lookup');
...
console.log('[SW] Advanced service worker for whois-lookup loaded successfully');