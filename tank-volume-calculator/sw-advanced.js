// Advanced Service Worker v4.0 - tank-volume-calculator
...
const CACHE_PREFIX = 'zovo-tankvolumecalculator';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for tank-volume-calculator');
...
console.log('[SW] Advanced service worker for tank-volume-calculator loaded successfully');