// Advanced Service Worker v4.0 - three-phase-power-calculator
...
const CACHE_PREFIX = 'zovo-threephasepowercalculator';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for three-phase-power-calculator');
...
console.log('[SW] Advanced service worker for three-phase-power-calculator loaded successfully');