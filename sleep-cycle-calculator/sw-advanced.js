// Advanced Service Worker v4.0 - sleep-cycle-calculator
...
const CACHE_PREFIX = 'zovo-sleepcyclecalculator';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for sleep-cycle-calculator');
...
console.log('[SW] Advanced service worker for sleep-cycle-calculator loaded successfully');