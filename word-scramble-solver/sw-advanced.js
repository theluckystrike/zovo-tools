// Advanced Service Worker v4.0 - word-scramble-solver
...
const CACHE_PREFIX = 'zovo-wordscramblesolver';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for word-scramble-solver');
...
console.log('[SW] Advanced service worker for word-scramble-solver loaded successfully');