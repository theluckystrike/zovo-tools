// Advanced Service Worker v4.0 - svg-optimizer
...
const CACHE_PREFIX = 'zovo-svgoptimizer';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for svg-optimizer');
...
console.log('[SW] Advanced service worker for svg-optimizer loaded successfully');