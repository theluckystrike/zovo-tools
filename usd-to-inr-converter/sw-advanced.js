// Advanced Service Worker v4.0 - usd-to-inr-converter
...
const CACHE_PREFIX = 'zovo-usdtoinrconverter';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for usd-to-inr-converter');
...
console.log('[SW] Advanced service worker for usd-to-inr-converter loaded successfully');