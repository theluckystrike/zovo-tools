// Advanced Service Worker v4.0 - treadmill-calorie-calculator
...
const CACHE_PREFIX = 'zovo-treadmillcaloriecalculator';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for treadmill-calorie-calculator');
...
console.log('[SW] Advanced service worker for treadmill-calorie-calculator loaded successfully');