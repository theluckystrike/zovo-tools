// Advanced Service Worker v4.0 - stud-spacing-calculator
...
const CACHE_PREFIX = 'zovo-studspacingcalculator';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for stud-spacing-calculator');
...
console.log('[SW] Advanced service worker for stud-spacing-calculator loaded successfully');