// Advanced Service Worker v4.0 - text-summarizer
...
const CACHE_PREFIX = 'zovo-textsummarizer';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for text-summarizer');
...
console.log('[SW] Advanced service worker for text-summarizer loaded successfully');