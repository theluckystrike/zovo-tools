// Advanced Service Worker v4.0 - usps-postage-calculator
...
const CACHE_PREFIX = 'zovo-uspspostagecalculator';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for usps-postage-calculator');
...
console.log('[SW] Advanced service worker for usps-postage-calculator loaded successfully');