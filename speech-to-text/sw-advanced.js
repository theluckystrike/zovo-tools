// Advanced Service Worker v4.0 - speech-to-text
...
const CACHE_PREFIX = 'zovo-speechtotext';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for speech-to-text');
...
console.log('[SW] Advanced service worker for speech-to-text loaded successfully');