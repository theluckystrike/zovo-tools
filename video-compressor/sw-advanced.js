// Advanced Service Worker v4.0 - video-compressor
...
const CACHE_PREFIX = 'zovo-videocompressor';
...
self.addEventListener('install', event => {
  console.log('[SW] Installing service worker for video-compressor');
...
console.log('[SW] Advanced service worker for video-compressor loaded successfully');